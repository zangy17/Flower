...
import torchvision
train_set = torchvision.datasets.Flowers102(root='/mnt/localssd/flower',split='train',download=True,transform=test_preprocess)
test_set = torchvision.datasets.Flowers102(root='/mnt/localssd/flower',split='test',download=True,transform=test_preprocess)
